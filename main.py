...
item_box = ItemBox('vie',100,560)
groupe_item_box.add(item_box)
item_box = ItemBox('balle',300,560)
groupe_item_box.add(item_box)
item_box = ItemBox('grenade',500,560)
groupe_item_box.add(item_box)


perso1 = personnage(2, 50, 150, 1.65, 2, 20, 5)
barre_vie = BarreVie(10,10, perso1.vie, perso1.max_vie)


enemi = personnage(1, 200, 560, 1.65, 1, 20, 0)
enemi2 = personnage(1, 500, 560, 1.65, 1, 20, 0)
